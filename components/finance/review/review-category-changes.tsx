    ...
    <div className="overflow-hidden rounded-2xl border bg-card">
      <div className="divide-y divide-border">
        {sorted.map((entry) => {
          ...
          return (
            <div key={entry.categoryId ?? entry.categoryName} className="flex items-center justify-between gap-3 p-4">
              ...
              <span className={cn("flex shrink-0 items-center gap-1 font-mono text-xs font-semibold tabular-nums", toneClass)}>
